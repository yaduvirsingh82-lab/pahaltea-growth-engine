...
- Phase 4 offline integration foundation implemented: provider contracts, read-only/sandbox mode enforcement, and raw-body Shopify/Meta webhook HMAC verification.
